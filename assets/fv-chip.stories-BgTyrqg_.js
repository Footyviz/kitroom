import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{S as n,dt as r,ft as i,ut as a}from"./iframe-CCcjCKbY.js";var o=t({CleansUpOnDisconnect:()=>O,Closable:()=>x,ClosableWithoutCloseButtonDoesNotCrash:()=>D,CloseDispatchesEvent:()=>w,CloseEventBubbles:()=>T,Counts:()=>C,Default:()=>v,NonClosableChipDoesNotDispatchClose:()=>E,Playground:()=>y,StatusVariants:()=>b,SurvivesHtmxSwap:()=>k,Teams:()=>S,__namedExportsOrder:()=>A,default:()=>u}),s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j=e((()=>{i(),n(),{expect:s,fn:c,userEvent:l}=__STORYBOOK_MODULE_TEST__,u={title:`Kitroom/Chip`,component:`fv-chip`,argTypes:{variant:{control:`select`,options:[`default`,`mono`,`strong`,`accent`,`info`,`warn`,`neg`,`pos`,`outline`,`live`],description:`data-variant — chooses hue / typography / animation`},text:{control:`text`,description:`Chip label text (text content)`}}},d=r`
...
`,f=`display: flex; gap: 8px; flex-wrap: wrap; align-items: center;`,p=e=>({docs:{source:{code:e,language:`html`}}}),m=`<svg width="8" height="8" viewBox="0 0 8 8" fill="none" stroke="currentColor" stroke-width="1.4" aria-hidden="true">
    ...
    </svg>`,h=e=>e.variant===`default`?`<fv-chip>${e.text}</fv-chip>`:`<fv-chip data-variant="${e.variant}">${e.text}</fv-chip>`,g=e=>r`
  <fv-chip data-variant="${e.variant===`default`?a:e.variant}">
    ${e.text}
  </fv-chip>
`,_=()=>({docs:{source:{language:`html`,transform:(e,t)=>h(t.args)}}}),v={args:{variant:`default`,text:`Premier League`},render:g,parameters:_()},y={args:{variant:`live`,text:`LIVE`},render:g,parameters:_()},b={render:()=>r`
    <div style="${f}">
...
<fv-chip data-variant="warn"><span data-role="dot" style="background:#B88700"></span>Delay</fv-chip>
<fv-chip data-variant="pos"><span data-role="dot" style="background:#3B7217"></span>Goal</fv-chip>
<fv-chip data-variant="neg">Red card</fv-chip>`)},x={render:()=>r`
    <div style="${f}">
...
<fv-chip data-variant="outline">+ Add filter</fv-chip>`)},S={render:()=>r`
    <div style="${f}">
...
<fv-chip data-variant="count">
  ...
  `,play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="chip"]`),n=t.querySelector(`[data-action="close"]`),r;t.addEventListener(`close`,e=>{r=e.detail.value}),await l.click(n),s(r).toBe(`arsenal`)}},T={render:()=>r`
  ...
  `,play:async({canvasElement:e})=>{let t=c();document.body.addEventListener(`close`,t);let n=e.querySelector(`[data-action="close"]`);await l.click(n),s(t).toHaveBeenCalledOnce();let r=t.mock.calls[0][0];s(r.detail).toEqual({value:`bubbles`}),s(r.bubbles).toBe(!0),document.body.removeEventListener(`close`,t)}},E={render:()=>r`
    <fv-chip data-testid="chip">Status</fv-chip>
  `,play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="chip"]`),n=c();document.addEventListener(`close`,n),await l.click(t),s(n).not.toHaveBeenCalled(),document.removeEventListener(`close`,n)}},D={render:()=>r`
  ...
  `,play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="chip"]`),n=c();document.addEventListener(`close`,n),await l.click(t),s(n).not.toHaveBeenCalled(),document.removeEventListener(`close`,n)}},O={render:()=>r`
  ...
  `,play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="host"]`),n=t.querySelector(`fv-chip`),r=n.querySelector(`[data-action="close"]`),i=0;n.addEventListener(`close`,()=>i++),s(i).toBe(0),await l.click(r),s(i).toBe(1),t.removeChild(n),r.click(),s(i).toBe(1)}},k={render:()=>r`
