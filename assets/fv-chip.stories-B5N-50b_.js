import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{C as n,dt as r,ft as i,pt as a}from"./iframe-C8v2Ub9I.js";var o=t({CleansUpOnDisconnect:()=>O,Closable:()=>x,ClosableWithoutCloseButtonDoesNotCrash:()=>D,CloseDispatchesEvent:()=>w,CloseEventBubbles:()=>T,Counts:()=>C,Default:()=>v,NonClosableChipDoesNotDispatchClose:()=>E,Playground:()=>y,StatusVariants:()=>b,SurvivesHtmxSwap:()=>k,Teams:()=>S,__namedExportsOrder:()=>A,default:()=>u}),s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j=e((()=>{a(),n(),{expect:s,fn:c,userEvent:l}=__STORYBOOK_MODULE_TEST__,u={title:`Kitroom/Chip`,component:`fv-chip`,argTypes:{variant:{control:`select`,options:[`default`,`mono`,`strong`,`accent`,`info`,`warn`,`neg`,`pos`,`outline`,`live`],description:`data-variant — chooses hue / typography / animation`},text:{control:`text`,description:`Chip label text (text content)`}}},d=i`
...
`,f=`display: flex; gap: 8px; flex-wrap: wrap; align-items: center;`,p=e=>({docs:{source:{code:e,language:`html`}}}),m=`<svg width="8" height="8" viewBox="0 0 8 8" fill="none" stroke="currentColor" stroke-width="1.4" aria-hidden="true">
      <path d="M1 1l6 6M7 1L1 7"/>
    </svg>`,h=e=>e.variant===`default`?`<fv-chip>${e.text}</fv-chip>`:`<fv-chip data-variant="${e.variant}">${e.text}</fv-chip>`,g=e=>i`
  <fv-chip data-variant="${e.variant===`default`?r:e.variant}">
    ${e.text}
  </fv-chip>
`,_=()=>({docs:{source:{language:`html`,transform:(e,t)=>h(t.args)}}}),v={args:{variant:`default`,text:`Premier League`},render:g,parameters:_()},y={args:{variant:`live`,text:`LIVE`},render:g,parameters:_()},b={render:()=>i`
    <div style="${f}">
  ...
  `,parameters:p(`<fv-chip data-variant="live">LIVE</fv-chip>
<fv-chip data-variant="mono">73'</fv-chip>
<fv-chip data-variant="strong"><span data-role="dot"></span>FT</fv-chip>
<fv-chip data-variant="info">VAR review</fv-chip>
<fv-chip data-variant="warn"><span data-role="dot" style="background:#B88700"></span>Delay</fv-chip>
<fv-chip data-variant="pos"><span data-role="dot" style="background:#3B7217"></span>Goal</fv-chip>
<fv-chip data-variant="neg">Red card</fv-chip>`)},x={render:()=>i`
    <div style="${f}">
      <fv-chip data-closable data-variant="accent" data-value="premier">
        Premier League
        <button data-action="close" aria-label="Remove Premier League">${d}</button>
      </fv-chip>
      <fv-chip data-closable data-value="arsenal">
        Arsenal
        <button data-action="close" aria-label="Remove Arsenal">${d}</button>
      </fv-chip>
      <fv-chip data-closable data-value="saka">
        Saka
        <button data-action="close" aria-label="Remove Saka">${d}</button>
      </fv-chip>
      <fv-chip data-variant="outline">+ Add filter</fv-chip>
    </div>
  `,parameters:p(`<fv-chip data-closable data-variant="accent" data-value="premier">
  Premier League
...
<fv-chip data-variant="outline">+ Add filter</fv-chip>`)},S={render:()=>i`
    <div style="${f}">
  ...
  `,parameters:p(`<fv-chip data-variant="team">
...
<fv-chip data-variant="team">
  ...
  `,parameters:p(`<fv-chip data-variant="count">
  <span>Followers</span>
...
<fv-chip data-variant="count">
  ...
  `,play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="chip"]`),n=t.querySelector(`[data-action="close"]`),r;t.addEventListener(`close`,e=>{r=e.detail.value}),await l.click(n),s(r).toBe(`arsenal`)}},T={render:()=>i`
    <div data-testid="parent">
      <fv-chip data-closable data-value="bubbles">
        Filter
        <button data-action="close" aria-label="Remove">${d}</button>
      </fv-chip>
    </div>
  `,play:async({canvasElement:e})=>{let t=c();document.body.addEventListener(`close`,t);let n=e.querySelector(`[data-action="close"]`);await l.click(n),s(t).toHaveBeenCalledOnce();let r=t.mock.calls[0][0];s(r.detail).toEqual({value:`bubbles`}),s(r.bubbles).toBe(!0),document.body.removeEventListener(`close`,t)}},E={render:()=>i`
    <fv-chip data-testid="chip">Status</fv-chip>
  `,play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="chip"]`),n=c();document.addEventListener(`close`,n),await l.click(t),s(n).not.toHaveBeenCalled(),document.removeEventListener(`close`,n)}},D={render:()=>i`
  ...
  `,play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="chip"]`),n=c();document.addEventListener(`close`,n),await l.click(t),s(n).not.toHaveBeenCalled(),document.removeEventListener(`close`,n)}},O={render:()=>i`
  ...
  `,play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="host"]`),n=t.querySelector(`fv-chip`),r=n.querySelector(`[data-action="close"]`),i=0;n.addEventListener(`close`,()=>i++),s(i).toBe(0),await l.click(r),s(i).toBe(1),t.removeChild(n),r.click(),s(i).toBe(1)}},k={render:()=>i`
  ...
  `,play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="container"]`);t.innerHTML=`
    ...
    `;let n=t.querySelector(`fv-chip`),r=n.querySelector(`[data-action="close"]`),i;n.addEventListener(`close`,e=>{i=e.detail.value}),s(i).toBeUndefined(),await l.click(r),s(i).toBe(`swapped`)}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
    variant: 'default',
    text: 'Premier League'
  },
...
}`,...k.parameters?.docs?.source}}},A=[`Default`,`Playground`,`StatusVariants`,`Closable`,`Teams`,`Counts`,`CloseDispatchesEvent`,`CloseEventBubbles`,`NonClosableChipDoesNotDispatchClose`,`ClosableWithoutCloseButtonDoesNotCrash`,`CleansUpOnDisconnect`,`SurvivesHtmxSwap`]}));j();export{O as CleansUpOnDisconnect,x as Closable,D as ClosableWithoutCloseButtonDoesNotCrash,w as CloseDispatchesEvent,T as CloseEventBubbles,C as Counts,v as Default,E as NonClosableChipDoesNotDispatchClose,y as Playground,b as StatusVariants,k as SurvivesHtmxSwap,S as Teams,A as __namedExportsOrder,u as default,j as n,o as t};