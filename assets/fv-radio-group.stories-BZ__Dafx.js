import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{_ as n,dt as r,ft as i,pt as a,v as o}from"./iframe-C8v2Ub9I.js";var s=t({ChildClickDoesNotDoubleEmit:()=>S,ChildClickUpdatesGroupAttribute:()=>b,CleansUpOnDisconnect:()=>C,Default:()=>_,Playground:()=>v,ProgrammaticAttrChangeBroadcastsAndEmits:()=>x,SurvivesHtmxSwap:()=>w,__namedExportsOrder:()=>T,default:()=>d}),c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E=e((()=>{a(),o(),n(),{expect:c,fn:l,userEvent:u}=__STORYBOOK_MODULE_TEST__,d={title:`Kitroom/RadioGroup`,component:`fv-radio-group`,argTypes:{selectedValue:{control:{type:`inline-radio`},description:`data-selected-value — which child fv-radio gets aria-checked="true"`},direction:{control:{type:`inline-radio`},options:[`column`,`row`]}}},f=[{value:`all`,label:`All comps`},{value:`followed`,label:`Followed only`},{value:`domestic`,label:`Domestic`}],p=(e,t,n)=>{let r=n.map(t=>`  <label>
...
${r}
</fv-radio-group>`},m=(e,t,n)=>i`
  <fv-radio-group
    data-selected-value="${e.selectedValue}"
    aria-label="${t}"
    data-direction="${e.direction===`column`?r:e.direction}"
  >
    ${n.map(t=>i`
        <label>
          <fv-radio data-value="${t.value}" aria-checked="${t.value===e.selectedValue?`true`:`false`}">
...
</fv-radio-group>`),play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="grp"]`),n=t.querySelectorAll(`fv-radio`),r={childChange:0,groupChange:0};n.forEach(e=>e.addEventListener(`change`,()=>{r.childChange++})),t.addEventListener(`change`,()=>{r.groupChange++}),await u.click(n[1]),c(r.childChange).toBe(1),c(r.groupChange).toBe(1)}},C={args:{selectedValue:`a`,direction:`column`},render:()=>i`
