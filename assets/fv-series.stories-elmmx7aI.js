import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{dt as n,ft as r,m as i,pt as a}from"./iframe-C8v2Ub9I.js";var o=t({ExposesAriaLabel:()=>h,FormVariants:()=>p,MaxVisible:()=>m,MaxVisibleHidesEarlyChildren:()=>g,Playground:()=>f,__namedExportsOrder:()=>_,default:()=>c}),s,c,l,u,d,f,p,m,h,g,_,v=e((()=>{a(),i(),{expect:s}=__STORYBOOK_MODULE_TEST__,c={title:`Kitroom/Series`,component:`fv-series`,argTypes:{pips:{control:`text`,description:`Space-separated pip values (e.g. "pos pos warn pos pos")`},label:{control:`text`,description:`aria-label describing the sequence`},maxVisible:{control:`text`,description:`data-max-visible — leave empty for unbounded; 1-10 hide all but the last N`}},parameters:{controls:{disable:!0}}},l=e=>({docs:{source:{code:e,language:`html`}}}),u=`font-family: var(--font-mono); font-size: 11px; color: var(--fg-subtle);`,d=e=>e.trim().split(/\s+/).filter(e=>e===`pos`||e===`warn`||e===`neg`),f={args:{pips:`pos pos warn pos pos`,label:`Last 5: W W D W W`,maxVisible:``},render:e=>r`
    <fv-series
      aria-label="${e.label}"
      data-max-visible="${e.maxVisible?e.maxVisible:n}"
    >
      ${d(e.pips).map(e=>r`<span data-pip="${e}"></span>`)}
    </fv-series>
...
`);return`<fv-series ${n.join(` `)}>\n${r}\n</fv-series>`}}},controls:{disable:!1}}},p={render:()=>r`
  ...
  `,parameters:l(`<fv-series aria-label="Last 5: W W D W W">…</fv-series>`),play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="s"]`);s(t.getAttribute(`role`)).toBe(`img`),s(t.getAttribute(`aria-label`)).toBe(`Last 5: W W D W W`),s(t.children.length).toBe(5)}},g={render:()=>r`
