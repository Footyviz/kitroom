...
`,p=e=>({docs:{source:{code:e,language:`html`}}}),m=`<svg data-role="check" viewBox="0 0 16 16" aria-hidden="true" fill="none"
  ...
  <label style="${d}${e.disabled?`; color: var(--fg-subtle);`:``}">
    <fv-checkbox
      ...
      data-variant="${e.variant===`ink`?n:e.variant}"
    >${f}</fv-checkbox>
    ${e.label}
  </label>
