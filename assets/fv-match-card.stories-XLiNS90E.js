import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{dt as n,ft as r,r as i}from"./iframe-CCcjCKbY.js";var a=t({Compact:()=>_,Dark:()=>v,Final:()=>g,FooterDispatchesExpandEvent:()=>b,Grid:()=>y,Live:()=>m,Upcoming:()=>h,__namedExportsOrder:()=>x,default:()=>c}),o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S=e((()=>{r(),i(),{expect:o,fn:s}=__STORYBOOK_MODULE_TEST__,c={title:`Locker Room/MatchCard`,component:`fv-match-card`,argTypes:{status:{control:{type:`inline-radio`},options:[`live`,`upcoming`,`final`],description:`data-status — drives chip color, score formatting, aria-live`},density:{control:{type:`inline-radio`},options:[`default`,`compact`],description:`data-density — tightens padding and shrinks fonts`}},parameters:{actions:{handles:[`fv-match-card-expand`]}}},l=e=>n`
...
}`,...b.parameters?.docs?.source}}},x=[`Live`,`Upcoming`,`Final`,`Compact`,`Dark`,`Grid`,`FooterDispatchesExpandEvent`]}));S();export{_ as Compact,v as Dark,g as Final,b as FooterDispatchesExpandEvent,y as Grid,m as Live,h as Upcoming,x as __namedExportsOrder,c as default,S as n,a as t};