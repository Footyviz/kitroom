...
<fv-toggle aria-checked="true" tabindex="-1">
  <span data-role="knob"></span>
</fv-toggle>`),play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="t"]`);s(t.getAttribute(`aria-checked`)).not.toBe(`false`),s(t.getAttribute(`aria-checked`)).toBe(`true`),s(t.getAttribute(`tabindex`)).not.toBe(`0`),s(t.getAttribute(`tabindex`)).toBe(`-1`),s(t.getAttribute(`role`)).toBe(`switch`)}},w={render:()=>r`
  ...
  `,play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="t"]`);s(t.getAttribute(`aria-checked`)).not.toBe(`true`),await l.click(t),s(t.getAttribute(`aria-checked`)).toBe(`true`)}},T={render:()=>r`
