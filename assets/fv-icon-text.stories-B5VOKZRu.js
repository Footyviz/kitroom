import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{B as n,V as r,z as i}from"./iframe-CnQc__3c.js";import{t as a}from"./fv-icon-text-kE0yc43d.js";var o=t({Default:()=>m,HandlesMissingLabel:()=>v,Horizontal:()=>h,Playground:()=>g,SurvivesHtmxSwap:()=>y,__namedExportsOrder:()=>b,default:()=>c}),s,c,l,u,d,f,p,m,h,g,_,v,y,b,x=e((()=>{r(),a(),{expect:s}=__STORYBOOK_MODULE_TEST__,c={title:`Components/IconText`,component:`fv-icon-text`,argTypes:{label:{control:`text`},direction:{control:{type:`inline-radio`},options:[`column`,`row`]},align:{control:{type:`inline-radio`},options:[`center`,`start`,`end`]},gap:{control:{type:`select`},options:[`default`,`xs`,`sm`,`md`,`lg`]}}},l=`<svg data-role="icon" width="22" height="22" viewBox="0 0 24 24" fill="none"
