import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{dt as n,ft as r,p as i,pt as a}from"./iframe-C8v2Ub9I.js";var o=t({ChangeEventBubblesWithValue:()=>x,ClampsToMinMax:()=>C,CleansUpOnDisconnect:()=>T,CustomRange:()=>_,Default:()=>g,Disabled:()=>v,DisabledIgnoresKeyboard:()=>w,HandlesMissingThumbAndFill:()=>E,KeyboardArrowsAdjustValue:()=>b,Playground:()=>y,StepRoundsKeyboardChanges:()=>S,SurvivesHtmxSwap:()=>D,__namedExportsOrder:()=>O,default:()=>u}),s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k=e((()=>{a(),i(),{expect:s,fn:c,userEvent:l}=__STORYBOOK_MODULE_TEST__,u={title:`Kitroom/Slider`,component:`fv-slider`,argTypes:{value:{control:{type:`number`},description:`data-value`},min:{control:{type:`number`},description:`data-min`},max:{control:{type:`number`},description:`data-max`},step:{control:{type:`number`},description:`data-step`},disabled:{control:`boolean`,description:`aria-disabled`}}},d=r`
...
`,f=`<span data-role="track"></span>
  ...
  ${f}
</fv-slider>`},m=e=>({docs:{source:{language:`html`,transform:(t,n)=>p(n.args,e)}}}),h=(e,t)=>r`
  <fv-slider
    data-value="${e.value}"
    data-min="${e.min===0?n:String(e.min)}"
    data-max="${e.max===100?n:String(e.max)}"
    data-step="${e.step===1?n:String(e.step)}"
    aria-disabled="${e.disabled?`true`:n}"
    aria-label="${t}"
  >${d}</fv-slider>
`,g={args:{value:62,min:0,max:100,step:1,disabled:!1},render:e=>r`
    <div style="display:inline-flex;align-items:center;gap:10px">
      ${h(e,`Volume`)}
      <span style="font-family:var(--font-mono);font-size:11px;color:var(--fg-muted)">${e.value}%</span>
    </div>
  `,parameters:m(`Volume`)},_={args:{value:40,min:0,max:120,step:5,disabled:!1},render:e=>h(e,`Match minute`),parameters:m(`Match minute`)},v={args:{value:40,min:0,max:100,step:1,disabled:!0},render:e=>h(e,`Disabled`),parameters:m(`Disabled`)},y={args:{value:50,min:0,max:100,step:1,disabled:!1},render:e=>r`
    <div style="display:inline-flex;align-items:center;gap:10px">
      ${h(e,`Volume`)}
      <span style="font-family:var(--font-mono);font-size:11px;color:var(--fg-muted)">${e.value}</span>
    </div>
  `,parameters:m(`Volume`)},b={render:()=>r`
  ...
  `,play:async({canvasElement:e})=>{let t=c();document.body.addEventListener(`change`,t),e.querySelector(`fv-slider`).focus(),await l.keyboard(`{ArrowRight}`),s(t).toHaveBeenCalledOnce();let n=t.mock.calls[0][0];s(n.detail).toEqual({value:51}),s(n.bubbles).toBe(!0),document.body.removeEventListener(`change`,t)}},S={render:()=>r`
    <fv-slider data-value="40" data-min="0" data-max="100" data-step="10"
               aria-label="Step" data-testid="s">${d}</fv-slider>
  `,play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="s"]`);t.focus(),s(t.getAttribute(`data-value`)).not.toBe(`50`),await l.keyboard(`{ArrowRight}`),s(t.getAttribute(`data-value`)).toBe(`50`),await l.keyboard(`{ArrowRight}{ArrowRight}`),s(t.getAttribute(`data-value`)).toBe(`70`)}},C={render:()=>r`
  ...
  `,play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="s"]`);t.focus(),s(t.getAttribute(`data-value`)).not.toBe(`51`),await l.keyboard(`{ArrowRight}`),s(t.getAttribute(`data-value`)).toBe(`51`)}},D={render:()=>r`
