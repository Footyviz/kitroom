import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{c as n,dt as r,ft as i,pt as a}from"./iframe-C8v2Ub9I.js";var o=t({Playground:()=>g,ReflectsMaxWidth:()=>x,Stats:()=>b,SurvivesHtmxSwap:()=>w,Tones:()=>v,Truncation:()=>y,TruncationStylesApply:()=>S,TypeRamp:()=>_,UpdatesMaxWidthOnAttributeChange:()=>C,__namedExportsOrder:()=>T,default:()=>c}),s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E=e((()=>{a(),n(),{expect:s}=__STORYBOOK_MODULE_TEST__,c={title:`Kitroom/Text`,component:`fv-text`,argTypes:{text:{control:`text`,description:`Slot content`},variant:{control:`select`,options:[`default`,`body`,`body-sm`,`caption`,`label`,`h1`,`h2`,`h3`,`display`,`display-serif`,`stat-xl`,`stat-lg`,`stat-md`,`stat-sm`,`mono`,`editorial`],description:"data-variant — picks the type style. `default` omits the attribute and falls back to body."},tone:{control:{type:`inline-radio`},options:[`default`,`muted`,`subtle`,`inverse`,`accent`],description:`data-tone — colour override (default keeps the variant's own colour)`},maxWidth:{control:`text`,description:`data-max-width — any CSS <length> (e.g. 200px, 20ch). When present, single-line ellipsis truncation kicks in.`}},parameters:{controls:{disable:!0}}},l=e=>({docs:{source:{code:e,language:`html`}}}),u=e=>{let t=[];return e.variant!==`default`&&t.push(`data-variant="${e.variant}"`),e.tone!==`default`&&t.push(`data-tone="${e.tone}"`),e.maxWidth&&t.push(`data-max-width="${e.maxWidth}"`),`<fv-text${t.length?` `+t.join(` `):``}>${e.text}</fv-text>`},d=()=>({docs:{source:{language:`html`,transform:(e,t)=>u(t.args)}}}),f=e=>i`
  <fv-text
    data-variant="${e.variant===`default`?r:e.variant}"
    data-tone="${e.tone===`default`?r:e.tone}"
    data-max-width="${e.maxWidth?e.maxWidth:r}"
    >${e.text}</fv-text
  >
`,p=`display: flex; flex-direction: column; gap: 16px; align-items: flex-start;`,m=`display: grid; grid-template-columns: 140px 1fr; gap: 18px 24px; align-items: baseline;`,h=`font-family: var(--font-mono); font-size: 11px; color: var(--fg-subtle);`,g={args:{text:`Saka advanced 11m before releasing the pass.`,variant:`body`,tone:`default`,maxWidth:``},render:f,parameters:{...d(),controls:{disable:!1}}},_={render:()=>i`
    <div style="${m}">
...
<fv-text data-variant="stat-sm">+0.08 xT</fv-text>
<fv-text data-variant="mono">12 438 passes</fv-text>
<fv-text data-variant="editorial">"The UI is the frame. The data is the painting."</fv-text>`)},v={render:()=>i`
    <div style="${p}">
      <div style="${m}">
...
<fv-text data-variant="caption">xT delta</fv-text>
<fv-text data-variant="stat-sm">+0.08 xT</fv-text>`)},x={render:()=>i`
  ...
  `,parameters:l(`<fv-text data-variant="body" data-max-width="180px">…</fv-text>`),play:async({canvasElement:e})=>{s(e.querySelector(`[data-testid="reflect"]`).style.maxWidth).toBe(`180px`)}},S={render:()=>i`
    <div>
