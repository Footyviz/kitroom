import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{c as n,d as r,ft as i,g as a,m as o,pt as s}from"./iframe-C8v2Ub9I.js";var c=t({BuildsAriaLabel:()=>x,Compact:()=>_,Default:()=>h,Featured:()=>g,FormLayout:()=>v,MultiRow:()=>y,StampsRowAndCellRoles:()=>b,__namedExportsOrder:()=>S,default:()=>u}),l,u,d,f,p,m,h,g,_,v,y,b,x,S,C=e((()=>{s(),r(),a(),n(),o(),{expect:l}=__STORYBOOK_MODULE_TEST__,u={title:`Kitroom/StatRow`,component:`fv-stat-row`,argTypes:{label:{control:`text`},homeValue:{control:`text`},awayValue:{control:`text`},homePct:{control:{type:`range`,min:0,max:100,step:1}},featured:{control:`boolean`},compact:{control:`boolean`}},parameters:{controls:{disable:!0}}},d=e=>({docs:{source:{code:e,language:`html`}}}),f=`
  display: flex;
...
`,p=`border-bottom: 1px solid var(--border-subtle);`,m=e=>{let t=e.homePct,n=100-t,r=e.featured?`accent`:null;return i`
    <div style="${f}">
      <fv-stat-row
