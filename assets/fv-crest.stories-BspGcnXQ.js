...
<fv-crest data-code="HAR" data-size="md"></fv-crest>
<fv-crest data-code="HAR" data-size="lg"></fv-crest>`)},_={render:()=>i`
...
<fv-crest data-code="KIN"></fv-crest>
<fv-crest data-code="WLD"></fv-crest>`)},y={render:()=>i`
    <div style="display: flex; flex-direction: column; gap: 16px;">
...
></fv-crest>`)},b={render:()=>i`
  ...
  `,parameters:l(`<fv-crest data-code="HAR"></fv-crest>`),play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="c"]`);s(t.textContent?.trim()).toBe(`HAR`),s(t.getAttribute(`role`)).toBe(`img`),s(t.getAttribute(`aria-label`)).toBe(`HAR`)}},x={render:()=>i`
    <fv-crest data-testid="c" data-code="HAR"></fv-crest>
  `,parameters:l(`<fv-crest data-code="HAR"></fv-crest>`),play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="c"]`);s(t.textContent?.trim()).toBe(`HAR`),t.setAttribute(`data-code`,`KIN`),s(t.textContent?.trim()).toBe(`KIN`),s(t.getAttribute(`aria-label`)).toBe(`KIN`),t.setAttribute(`data-alt`,`Kingsmoor FC`),s(t.getAttribute(`aria-label`)).toBe(`Kingsmoor FC`)}},S={render:()=>i`
    <fv-crest data-testid="c" data-code="har"></fv-crest>
