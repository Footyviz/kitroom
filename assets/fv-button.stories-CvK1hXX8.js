import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{B as n,V as r,z as i}from"./iframe-CnQc__3c.js";import{t as a}from"./fv-button-badge-Dtk-_T3l.js";import{t as o}from"./fv-button-BGy3fMgy.js";import{t as s}from"./fv-icon-cSwpiE2c.js";var c=t({ClickFiresEvent:()=>w,DisabledBlocksClickAndKeyboard:()=>E,Hierarchy:()=>y,LoadingBlocksClick:()=>D,OnDark:()=>C,Playground:()=>v,Sizes:()=>b,SpaceAndEnterActivate:()=>T,States:()=>x,SurvivesHtmxSwap:()=>k,TabindexFlipsWithDisabled:()=>O,WithIcon:()=>S,__namedExportsOrder:()=>A,default:()=>f}),l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j=e((()=>{r(),o(),a(),s(),{expect:l,fn:u,userEvent:d}=__STORYBOOK_MODULE_TEST__,f={title:`Components/Button`,component:`fv-button`,argTypes:{label:{control:`text`},variant:{control:`select`,options:[`default`,`primary`,`cream`,`secondary`,`outline`,`ghost`,`destructive`],description:`data-variant — default is the secondary white-card style`},size:{control:{type:`inline-radio`},options:[`xs`,`sm`,`default`,`lg`],description:`data-size — default is medium (no attribute)`},loading:{control:`boolean`,description:`data-loading`},disabled:{control:`boolean`,description:`aria-disabled`}},parameters:{controls:{disable:!0}}},p=e=>({docs:{source:{code:e,language:`html`}}}),m=e=>{let t=[];return e.variant!==`default`&&t.push(`data-variant="${e.variant}"`),e.size!==`default`&&t.push(`data-size="${e.size}"`),e.disabled&&t.push(`aria-disabled="true"`),e.loading&&t.push(`data-loading`),`<fv-button${t.length?` `+t.join(` `):``}>${e.label}</fv-button>`},h=()=>({docs:{source:{language:`html`,transform:(e,t)=>m(t.args)}}}),g=e=>n`
  <fv-button
...
`,v={args:{label:`Open match`,variant:`primary`,size:`default`,loading:!1,disabled:!1},render:g,parameters:{...h(),controls:{disable:!1}}},y={render:()=>_(n`<fv-button data-variant="primary">Open match</fv-button>`,n`<fv-button data-variant="cream"><fv-icon name="live"></fv-icon><span>Watch live</span></fv-button>`,n`<fv-button data-variant="secondary">Compare sides</fv-button>`,n`<fv-button data-variant="outline">Save match</fv-button>`,n`<fv-button data-variant="ghost">Dismiss</fv-button>`,n`<fv-button data-variant="destructive">Remove</fv-button>`),parameters:p(`<fv-button data-variant="primary">Open match</fv-button>
...
<fv-button data-variant="destructive">Remove</fv-button>`)},b={render:()=>_(n`<fv-button data-variant="primary" data-size="xs">XS</fv-button>`,n`<fv-button data-variant="primary" data-size="sm">Small</fv-button>`,n`<fv-button data-variant="primary">Default</fv-button>`,n`<fv-button data-variant="primary" data-size="lg">Large</fv-button>`,n`<fv-button data-variant="secondary" aria-label="Share"><fv-icon name="share"></fv-icon></fv-button>`,n`<fv-button data-variant="secondary" data-size="lg" aria-label="Notify"><fv-icon name="bell"></fv-icon></fv-button>`),parameters:p(`<fv-button data-variant="primary" data-size="xs">XS</fv-button>
...
<fv-button data-variant="secondary" data-size="lg" aria-label="Notify"><fv-icon name="bell"></fv-icon></fv-button>`)},x={render:()=>n`
    <div style="display: flex; flex-direction: column; gap: 10px;">
      ${_(n`<fv-button data-variant="primary">Default</fv-button>`,n`<fv-button data-variant="primary" aria-disabled="true">Disabled</fv-button>`,n`<fv-button data-variant="primary" data-loading>Loading</fv-button>`)}
      ${_(n`<fv-button data-variant="cream">Default</fv-button>`,n`<fv-button data-variant="cream" aria-disabled="true">Disabled</fv-button>`,n`<fv-button data-variant="cream" data-loading>Loading</fv-button>`)}
      ${_(n`<fv-button>Default</fv-button>`,n`<fv-button aria-disabled="true">Disabled</fv-button>`,n`<fv-button data-loading>Loading</fv-button>`)}
    </div>
...
<fv-button data-variant="primary" data-loading>Loading</fv-button>`)},S={render:()=>_(n`<fv-button data-variant="primary"><fv-icon name="live"></fv-icon><span>Watch live</span></fv-button>`,n`<fv-button data-variant="secondary"><fv-icon name="bell"></fv-icon><span>Notify me</span></fv-button>`,n`<fv-button data-variant="ghost"><fv-icon name="share"></fv-icon><span>Share</span></fv-button>`,n`<fv-button data-variant="destructive"><fv-icon name="card"></fv-icon><span>Remove</span></fv-button>`),parameters:p(`<fv-button data-variant="primary"><fv-icon name="live"></fv-icon><span>Watch live</span></fv-button>
...
<fv-button data-variant="destructive"><fv-icon name="card"></fv-icon><span>Remove</span></fv-button>`)},C={render:()=>n`
    <div data-theme="dark" style="background: var(--bg); padding: 16px 18px; border-radius: 14px;">
      ${_(n`<fv-button>Open match</fv-button>`,n`<fv-button data-variant="cream">Watch live</fv-button>`,n`<fv-button data-variant="outline">Compare sides</fv-button>`,n`<fv-button data-variant="ghost">Dismiss</fv-button>`)}
    </div>
