import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{dt as n,ft as r,pt as i,u as a,y as o}from"./iframe-C8v2Ub9I.js";var s=t({ButtonTabs:()=>C,ChangeEventBubbles:()=>E,CleansUpOnDisconnect:()=>O,ClickingMovesActive:()=>T,Default:()=>S,DisabledTabsAreNotActivated:()=>D,HandlesEmptyTabbar:()=>k,Playground:()=>w,SurvivesHtmxSwap:()=>A,__namedExportsOrder:()=>j,default:()=>d}),c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M=e((()=>{i(),o(),a(),{expect:c,fn:l,userEvent:u}=__STORYBOOK_MODULE_TEST__,d={title:`Kitroom/Tabbar`,component:`fv-tabbar`,argTypes:{current:{control:{type:`select`},options:[`live`,`fixtures`,`observe`,`follow`,`you`],description:`data-value of the tab marked aria-current="page"`}}},f={live:`<svg data-role="icon" viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="5" width="18" height="14" rx="1.5"/><path d="M12 5v14"/><circle cx="12" cy="12" r="2.2"/><circle cx="12" cy="12" r="4.2" opacity=".35"/></svg>`,fixtures:`<svg data-role="icon" viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="5" width="7.5" height="14" rx="1.2"/><rect x="13.5" y="5" width="7.5" height="14" rx="1.2"/><path d="M6.5 10h1.5M6.5 14h1.5M16 10h1.5M16 14h1.5"/></svg>`,observe:`<svg data-role="icon" viewBox="0 0 24 24" aria-hidden="true"><circle cx="10.5" cy="10.5" r="6.5"/><path d="M15.3 15.3 20 20"/><path d="M7.5 10.5h6M10.5 7.5v6" opacity=".55"/></svg>`,follow:`<svg data-role="icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M6 3h12v17l-6-4-6 4Z"/><path d="M9 8h6M9 11h6" opacity=".55"/></svg>`,you:`<svg data-role="icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M8 3 4 6v4l3-1v10a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V9l3 1V6l-4-3"/><path d="M8 3c0 2 1.8 3.5 4 3.5S16 5 16 3"/></svg>`},p=r`
...
${r.map(t=>{let r=t.value===e.current?` aria-current="page"`:``,i=n===`a`?`<a href="${t.href}" role="tab" data-value="${t.value}"${r}>`:`<button type="button" role="tab" data-value="${t.value}"${r}>`,a=n===`a`?`</a>`:`</button>`;return`  ${i}
  ...
  ${a}`}).join(`
`)}
</fv-tabbar>`,b=(e,t,i,a)=>r`
  <fv-tabbar aria-label="${t}">
    ${a.map(t=>{let a=t.value===e.current?`page`:n,o=r`
        <fv-icon-text>
          ${t.icon}
          <span data-role="label">${t.label}</span>
        </fv-icon-text>
        <span data-role="indicator"></span>
      `;return i===`a`?r`<a href="${t.href}" role="tab" data-value="${t.value}" aria-current="${a}">${o}</a>`:r`<button type="button" role="tab" data-value="${t.value}" aria-current="${a}">${o}</button>`})}
  </fv-tabbar>
`,x=(e,t,n=v)=>({docs:{source:{language:`html`,transform:(r,i)=>y(i.args,e,t,n)}}}),S={args:{current:`live`},render:e=>b(e,`Main navigation`,`a`,v),parameters:x(`Main navigation`,`a`)},C={args:{current:`live`},argTypes:{current:{control:{type:`select`},options:[`live`,`fixtures`,`observe`]}},render:e=>b(e,`Section`,`button`,v.slice(0,3)),parameters:x(`Section`,`button`,v.slice(0,3))},w={args:{current:`fixtures`},render:e=>b(e,`Main navigation`,`a`,v),parameters:x(`Main navigation`,`a`)},T={render:()=>r`
  ...
  `,play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="bar"]`),n;t.addEventListener(`change`,e=>{n=e.detail.value});let r=t.querySelectorAll(`[role="tab"]`);c(r[0]?.getAttribute(`aria-current`)).not.toBeNull(),c(r[2]?.getAttribute(`aria-current`)).toBeNull(),await u.click(r[2]),c(r[0]?.getAttribute(`aria-current`)).toBeNull(),c(r[2]?.getAttribute(`aria-current`)).toBe(`page`),c(n).toBe(`c`),c(r[1]?.getAttribute(`aria-current`)).toBeNull(),await u.click(r[1]),c(r[1]?.getAttribute(`aria-current`)).toBe(`page`),c(r[2]?.getAttribute(`aria-current`)).toBeNull(),c(n).toBe(`b`)}},E={render:()=>r`
  ...
  `,play:async({canvasElement:e})=>{let t=l();document.body.addEventListener(`change`,t);let n=e.querySelectorAll(`[role="tab"]`);await u.click(n[1]),c(t).toHaveBeenCalledOnce();let r=t.mock.calls[0][0];c(r.detail).toEqual({value:`b`}),c(r.bubbles).toBe(!0),document.body.removeEventListener(`change`,t)}},D={render:()=>r`
  ...
  `,play:async({canvasElement:e})=>{let t=e.querySelectorAll(`[role="tab"]`);c(t[0]?.getAttribute(`aria-current`)).toBe(`page`),c(t[1]?.getAttribute(`aria-current`)).toBeNull(),await u.click(t[1]),c(t[0]?.getAttribute(`aria-current`)).toBe(`page`),c(t[1]?.getAttribute(`aria-current`)).toBeNull()}},O={render:()=>r`
