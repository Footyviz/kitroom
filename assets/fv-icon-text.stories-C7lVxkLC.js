import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{dt as n,ft as r,pt as i,y as a}from"./iframe-C8v2Ub9I.js";var o=t({Default:()=>m,HandlesMissingLabel:()=>v,Horizontal:()=>h,Playground:()=>g,SurvivesHtmxSwap:()=>y,__namedExportsOrder:()=>b,default:()=>c}),s,c,l,u,d,f,p,m,h,g,_,v,y,b,x=e((()=>{i(),a(),{expect:s}=__STORYBOOK_MODULE_TEST__,c={title:`Kitroom/IconText`,component:`fv-icon-text`,argTypes:{label:{control:`text`},direction:{control:{type:`inline-radio`},options:[`column`,`row`]},align:{control:{type:`inline-radio`},options:[`center`,`start`,`end`]},gap:{control:{type:`select`},options:[`default`,`xs`,`sm`,`md`,`lg`]}}},l=`<svg data-role="icon" width="22" height="22" viewBox="0 0 24 24" fill="none"
...
`,d=e=>{let t=[];return e.direction!==`column`&&t.push(`data-direction="${e.direction}"`),e.align!==`center`&&t.push(`data-align="${e.align}"`),e.gap!==`default`&&t.push(`data-gap="${e.gap}"`),`${t.length?`<fv-icon-text ${t.join(` `)}>`:`<fv-icon-text>`}
  ...
  <fv-icon-text
    data-direction="${e.direction===`column`?n:e.direction}"
    data-align="${e.align===`center`?n:e.align}"
    data-gap="${e.gap===`default`?n:e.gap}"
  >
    ${u}
    <span data-role="label">${e.label}</span>
  </fv-icon-text>
`,p=()=>({docs:{source:{language:`html`,transform:(e,t)=>d(t.args)}}}),m={args:{label:`Live`,direction:`column`,align:`center`,gap:`default`},render:f,parameters:p()},h={args:{label:`Live`,direction:`row`,align:`center`,gap:`md`},render:f,parameters:p()},g={args:{label:`Live`,direction:`column`,align:`center`,gap:`default`},render:f,parameters:p()},_=e=>({docs:{source:{code:e,language:`html`}}}),v={args:{label:``,direction:`column`,align:`center`,gap:`default`},render:()=>r`
...
<fv-icon-text>
  ${l}
</fv-icon-text>`),play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="bare"]`);s(t.querySelector(`[data-role="icon"]`)).not.toBeNull(),s(t.querySelector(`[data-role="label"]`)).toBeNull()}},y={args:{label:``,direction:`column`,align:`center`,gap:`default`},render:()=>r`
