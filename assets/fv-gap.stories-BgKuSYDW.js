import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{E as n,b as r,dt as i,ft as a,pt as o,x as s}from"./iframe-C8v2Ub9I.js";var c=t({InToolbar:()=>g,Playground:()=>m,Scale:()=>h,__namedExportsOrder:()=>_,default:()=>d}),l,u,d,f,p,m,h,g,_,v=e((()=>{o(),s(),n(),r(),l=[`1`,`2`,`3`,`4`,`6`,`8`,`12`,`16`,`24`],u={1:`4px`,2:`8px`,3:`12px`,4:`16px`,6:`24px`,8:`32px`,12:`48px`,16:`64px`,24:`96px`},d={title:`Kitroom/Gap`,component:`fv-gap`,argTypes:{size:{control:`select`,options:[`none`,...l],description:`data-size — one of the 9 spec spacing steps; "none" omits the attribute`}},parameters:{controls:{disable:!0}}},f=e=>({docs:{source:{code:e,language:`html`}}}),p=e=>a`
  <span style="
  ...
  ">${e}</span>
`,m={args:{size:`4`},render:({size:e})=>a`
    <div style="display: inline-flex; align-items: center;">
      ${p(`A`)}
      <fv-gap data-size="${e===`none`?i:e}"></fv-gap>
      ${p(`B`)}
    </div>
  `,parameters:{docs:{source:{language:`html`,transform:(e,t)=>t.args.size===`none`?`<span>A</span><fv-gap></fv-gap><span>B</span>`:`<span>A</span><fv-gap data-size="${t.args.size}"></fv-gap><span>B</span>`}},controls:{disable:!1}}},h={render:()=>a`
