import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{dt as n,ft as r,pt as i,v as a}from"./iframe-C8v2Ub9I.js";var o=t({CleansUpOnDisconnect:()=>x,Default:()=>g,Disabled:()=>v,Group:()=>_,HandlesMissingDataGroup:()=>C,HandlesMissingDot:()=>S,Playground:()=>y,SelectingOneDeselectsSiblings:()=>b,SurvivesHtmxSwap:()=>w,__namedExportsOrder:()=>T,default:()=>u}),s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E=e((()=>{i(),a(),{expect:s,fn:c,userEvent:l}=__STORYBOOK_MODULE_TEST__,u={title:`Kitroom/Radio`,component:`fv-radio`,argTypes:{checked:{control:`boolean`,description:`aria-checked`},disabled:{control:`boolean`,description:`aria-disabled`},label:{control:`text`,description:`Visible label (sibling of the radio in the wrapping <label>)`}}},d=`display: inline-flex; align-items: center; gap: 8px; font-size: 13px; cursor: pointer;`,f=e=>({docs:{source:{code:e,language:`html`}}}),p=(e,t=`all`)=>{let n=[`data-group="comps"`,`data-value="${t}"`];return e.checked&&n.unshift(`aria-checked="true"`),e.disabled&&n.push(`aria-disabled="true"`),`<label>
  <fv-radio ${n.join(` `)}>
    <span data-role="dot"></span>
  </fv-radio>
  ${e.label}
</label>`},m=e=>({docs:{source:{language:`html`,transform:(t,n)=>p(n.args,e)}}}),h=(e,t,i=`all`)=>r`
  <label style="${d}${e.disabled?`; color: var(--fg-subtle);`:``}">
    <fv-radio
      aria-checked="${e.checked?`true`:n}"
...
`,g={args:{checked:!1,disabled:!1,label:`All comps`},render:e=>h(e,`story-default`),parameters:m()},_={render:()=>r`
...
</div>`)},v={args:{checked:!1,disabled:!0,label:`Champions League (premium)`},render:e=>h(e,`story-disabled`,`ucl`),parameters:m(`ucl`)},y={args:{checked:!0,disabled:!1,label:`All comps`},render:e=>h(e,`story-playground`),parameters:m()},b={render:()=>r`
  ...
  `,play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="grp"]`),n=t.querySelectorAll(`fv-radio`),r;t.addEventListener(`change`,e=>{r=e.detail.value}),s(n[0]?.getAttribute(`aria-checked`)).not.toBe(`false`),s(n[2]?.getAttribute(`aria-checked`)).not.toBe(`true`),await l.click(n[2]),s(n[0]?.getAttribute(`aria-checked`)).toBe(`false`),s(n[1]?.getAttribute(`aria-checked`)).toBe(`false`),s(n[2]?.getAttribute(`aria-checked`)).toBe(`true`),s(r).toBe(`c`),s(n[1]?.getAttribute(`aria-checked`)).not.toBe(`true`),await l.click(n[1]),s(n[1]?.getAttribute(`aria-checked`)).toBe(`true`),s(n[2]?.getAttribute(`aria-checked`)).toBe(`false`),s(r).toBe(`b`)}},x={render:()=>r`
    <div data-testid="host">
      <fv-radio data-group="cleanup-grp" data-value="x">
        <span data-role="dot"></span>
      </fv-radio>
    </div>
  `,play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="host"]`),n=t.querySelector(`fv-radio`);s(n.getAttribute(`aria-checked`)).not.toBe(`true`),await l.click(n),s(n.getAttribute(`aria-checked`)).toBe(`true`),t.removeChild(n);let r=c();document.addEventListener(`change`,r),n.click(),s(r).not.toHaveBeenCalled(),document.removeEventListener(`change`,r)}},S={render:()=>r`
    <fv-radio data-group="missing-dot" data-value="x" data-testid="r"></fv-radio>
  `,play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="r"]`);s(t.getAttribute(`aria-checked`)).not.toBe(`true`),await l.click(t),s(t.getAttribute(`aria-checked`)).toBe(`true`)}},C={render:()=>r`
  ...
  `,play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="lone"]`),n=e.querySelector(`[data-testid="other"]`);s(t.getAttribute(`aria-checked`)).not.toBe(`true`),await l.click(t),s(t.getAttribute(`aria-checked`)).toBe(`true`),s(n.getAttribute(`aria-checked`)).toBe(`false`)}},w={render:()=>r`
