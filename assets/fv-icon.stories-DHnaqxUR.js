import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{b as n,dt as r,ft as i,n as a,pt as o,t as s}from"./iframe-C8v2Ub9I.js";var c=t({Catalog:()=>S,Default:()=>y,MarksDecorativeByDefault:()=>E,Playground:()=>C,RendersSymbolReference:()=>w,Sizes:()=>b,Tones:()=>x,UpdatesOnNameChange:()=>T,__namedExportsOrder:()=>D,default:()=>u}),l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O=e((()=>{o(),n(),a(),{expect:l}=__STORYBOOK_MODULE_TEST__,u={title:`Kitroom/Icon`,component:`fv-icon`,argTypes:{name:{control:`select`,options:s,description:`Icon name — references <symbol id="icon-NAME"> in the page sprite`},size:{control:{type:`inline-radio`},options:[`default`,`sm`,`md`,`lg`],description:`data-size — sm: 16px · md: 20px · lg: 28px (default = md)`},tone:{control:{type:`inline-radio`},options:[`default`,`accent`,`muted`],description:`data-tone — currentColor / --accent / --fg-muted`}}},d=`display: flex; gap: 18px; flex-wrap: wrap; align-items: center;`,f=`display: grid; grid-template-columns: repeat(6, minmax(0, 1fr)); gap: 22px 14px;`,p=`display: flex; flex-direction: column; gap: 8px; align-items: center;`,m=`font-family: var(--font-mono); font-size: 10px; color: var(--fg-subtle);`,h=e=>({docs:{source:{code:e,language:`html`}}}),g=e=>{let t=[`name="${e.name}"`];return e.size!==`default`&&t.push(`data-size="${e.size}"`),e.tone!==`default`&&t.push(`data-tone="${e.tone}"`),`<fv-icon ${t.join(` `)}></fv-icon>`},_=e=>i`
  <fv-icon
    name="${e.name}"
    data-size="${e.size===`default`?r:e.size}"
    data-tone="${e.tone===`default`?r:e.tone}"
  ></fv-icon>
`,v=()=>({docs:{source:{language:`html`,transform:(e,t)=>g(t.args)}}}),y={args:{name:`pitch`,size:`default`,tone:`default`},render:_,parameters:v()},b={args:{name:`ball`,size:`default`,tone:`default`},render:()=>i`
    <div style="${d}">
...
<fv-icon name="ball" data-size="md"></fv-icon>
<fv-icon name="ball" data-size="lg"></fv-icon>`)},x={args:{name:`live`,size:`default`,tone:`default`},render:()=>i`
    <div style="${d}">
...
<fv-icon name="live" data-size="lg" data-tone="accent"></fv-icon>
<fv-icon name="live" data-size="lg" data-tone="muted"></fv-icon>`)},S={args:{name:`pitch`,size:`default`,tone:`default`},render:()=>i`
    <div style="${f}">
      ${s.map(e=>i`
          <div style="${p}">
...
<fv-icon name="ball" data-size="lg"></fv-icon>
<!-- ...etc. -->`)},C={args:{name:`pitch`,size:`default`,tone:`default`},render:_,parameters:v()},w={args:{name:`pitch`,size:`default`,tone:`default`},render:()=>i`<fv-icon data-testid="ref" name="pitch"></fv-icon>`,parameters:h(`<fv-icon name="pitch"></fv-icon>`),play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="ref"]`).querySelector(`use`);l(t).not.toBeNull(),l(t?.getAttribute(`href`)).toBe(`#icon-pitch`)}},T={args:{name:`pitch`,size:`default`,tone:`default`},render:()=>i`<fv-icon data-testid="reactive" name="pitch"></fv-icon>`,parameters:h(`<fv-icon name="pitch"></fv-icon>`),play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="reactive"]`);l(t.querySelector(`use`)?.getAttribute(`href`)).toBe(`#icon-pitch`),t.setAttribute(`name`,`ball`),l(t.querySelector(`use`)?.getAttribute(`href`)).toBe(`#icon-ball`)}},E={args:{name:`pitch`,size:`default`,tone:`default`},render:()=>i`
    <div>
