---
"@footyviz/formations": minor
"@footyviz/styles": minor
---

Introduce `@footyviz/formations`, the new home for composed arrangements of components — named after football's tactical shapes (4-3-3, 4-4-2: arrangements of players that become greater than their parts). Built on top of the primitives in `@footyviz/components`. The first formation is `<fv-table>`.
...
- New `@footyviz/formations/src/fv-table.ts`.
